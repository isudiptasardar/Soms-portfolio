...
export default function Publications() {
  ...
  return (
    <section id="publications" className="py-20 bg-zinc-50 dark:bg-zinc-800">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-bold mb-16 text-center">Publications</h2>
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <div className="flex-1">
                    ...
                    <h3 className="text-xl font-semibold mb-2 line-clamp-2">{publication.title}</h3>
                  ...
                  <div className="mt-4 pt-4 border-t border-zinc-100 dark:border-zinc-600">
                    <Link
                      href={`/publications#pub-${publication.id}`}
