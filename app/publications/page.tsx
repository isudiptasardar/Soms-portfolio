...
export const metadata: Metadata = {
  title: "Publications",
  description:
    "Complete list of publications by Somenath Dutta in bioinformatics, CADD, miRNA therapeutics and RNA biology",
  openGraph: {
    title: "Publications | Somenath Dutta",
    description:
      "Complete list of publications by Somenath Dutta in bioinformatics, CADD, miRNA therapeutics and RNA biology",
  },
}
    ...
    <div className="min-h-screen bg-white dark:bg-zinc-900 text-zinc-800 dark:text-zinc-200 transition-colors duration-300">
      ...
      <main className="container mx-auto px-4 py-20">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-12">Publications</h1>
